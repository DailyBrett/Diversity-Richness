...
[^1]: `r cite_r("new-r-references.bib")`

# Results


(ref:a-path-caption) Scatterplot demonstrating relationship the relationship between racial homogeneity in a Participant's ZIP Code and the participant's meaning in life scores.
...
Figure\ \@ref(fig:a-path-scatterplot) demonstrates ($r$ = `r div_happ_correlation$r`)



(ref:b-path-caption) Scatterplot demonstrating the relationship between the racial homogeneity in a Participant's ZIP Code and the participant's meaning in life scores.
```{r b-path-scatterplot, fig.cap="(ref:b-path-caption)", echo=FALSE, fig.pos='H', out.width='100%', warning=FALSE}
ggplot(Zip_Richness_Diversity) +
...
Figure\ \@ref(fig:b-path-scatterplot) demonstrates  ($r$ = `r div_meaning_correlation$r`)

(ref:c-path-caption) Scatterplot demonstrating the relationship between the racial homogeneity in a Participant's ZIP Code and the participant's psychological richness scores.
```{r c-path-scatterplot, fig.cap="(ref:c-path-caption)", echo=FALSE, fig.pos='H', out.width='100%', warning=FALSE}
ggplot(Zip_Richness_Diversity) +
...
Figure\ \@ref(fig:c-path-scatterplot) demonstrates  ($r$ = `r div_rich_correlation$r`)
...
Figure\ \@ref(fig:d-path-smooth) demonstrates 


(ref:e-path-caption) Box plot comparing the relationships between the region particpants were from and their psychological richness scores. 
```{r e-path-box, fig.cap = "(ref:e-path-caption)", echo=FALSE, fig.pos='H', out.width='100%', warning=FALSE}
...
Figure\ \@ref(fig:e-path-box) demonstrates
...
(ref:f-path-caption) Smooth plot comparing the relationships between community whiteness and individual psychological richness based on the region particpants were from. 
```{r f-path-smooth, fig.cap = "(ref:f-path-caption)", echo=FALSE, fig.pos='H', out.width='100%', warning=FALSE}
...
Figure\ \@ref(fig:f-path-smooth) demonstrates
...
Figure\ \@ref(fig:g-path-smooth) demonstrates
...
```{r rich-control-regression2, echo=FALSE, results='asis', fig.pos='H', warning=FALSE}
...
stargazer(psych_walkscore_interaction,
          psych_segregation_interaction, title = "Psych Richness Interaction Regression", header = FALSE, type = 'latex', dep.var.labels = c("Richness-Walkability Interaction", "Richness-Segregation Interaction"), covariate.labels = c("ZIP Code Percent White", "Walkscore", "Whiteness:Walkscore", "Segregation", "Segregation:Walkscore", "Mobility Score"), column.sep.width = "1pt", font.size = "tiny", label = "tab:rich-interaction-regression", out="rich-interaction-regression.png")
```
