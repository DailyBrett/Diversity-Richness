...
knitr::include_graphics("~/repos/Diversity-Richness/Thesis-Analysis/Richness-Diversity-Markdown_files/figure-latex/b-path-scatterplot-1.png")
```

```{r meaning-appendix, echo=FALSE, out.width="70%", fig.cap="(ref:c-path-caption)", fig.pos="H"}
knitr::include_graphics("~/repos/Diversity-Richness/Thesis-Analysis/Richness-Diversity-Markdown_files/figure-latex/c-path-scatterplot-1.png")
```

```{r box-appendix, echo=FALSE, out.width="70%", fig.cap="(ref:f-path-caption)", fig.pos="H"}
knitr::include_graphics("~/repos/Diversity-Richness/Thesis-Analysis/Richness-Diversity-Markdown_files/figure-latex/f-path-box-1.png")
```
