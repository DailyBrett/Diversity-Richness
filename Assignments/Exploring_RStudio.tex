...
\urlstyle{same}
\hypersetup{
  pdftitle={Exploring RStudio},
  pdfauthor={Brett Neely PetersonThe University of Chicago},
  pdflang={en-EN},
  pdfkeywords={keywords},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Exploring RStudio}
\author{Brett Neely Peterson\textsuperscript{The University of Chicago}}
\date{}
...
Correspondence concerning this article should be addressed to Brett Neely Peterson, Chicago, IL. E-mail: \href{mailto:bnpeterson@uchicago.edu}{\nolinkurl{bnpeterson@uchicago.edu}}
...
\hypertarget{loading-functions-and-scripts}{%
\section{1. Loading Functions and scripts}\label{loading-functions-and-scripts}}

\begin{verbatim}
## [1] "Greetings Dr. Dowling, how are you? I hope you are having a lovely Spring!"
\end{verbatim}

\hypertarget{research-analysis}{%
\section{2. Research Analysis}\label{research-analysis}}

\textbf{Potenial Locations}
- \emph{City Level data}
- Chicago
- Dallas
- \emph{County Level Data}
- Cook
-Dallas
- \emph{Zip Code Level Data}
- 60637
- 76116

\textbf{Experiment Approaches}
1. \emph{Experiment}
1. 250 particapnts
2. race of friend network
2. \emph{City Analysis}
1. 50 cities
2. psych richness survey
3. \emph{Proxy Data}
1. World Values Survey
2. 10 years

\href{https://www.socialexplorer.com/explore-maps}{Link to Social Explorer}

\hypertarget{preloaded-info}{%
\section{3. Preloaded Info}\label{preloaded-info}}
