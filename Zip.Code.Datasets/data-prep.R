...
# 1) Descriptive: Looking at mean and distribution of the three primary well being scores (happiness, well-being, psych richness) across the participants 
# Backup if delayed data: looking at the mean and distribution of income across the zipcodes 
# 2) Descriptive: Determining the diversity score of each zip code based ob the the different demographic percentages in each zip code
# 3) Hypothesis Testing: Relationship of Diversity Scores on Psych Richness
# Independent: Zip Code Diversity
# Dependent: Psych Richness
# Expected Results: Greater diversity leads to higher psych richness
# lm is likely most appropriate test
