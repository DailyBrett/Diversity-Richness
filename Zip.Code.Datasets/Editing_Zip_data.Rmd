...
```
(ref:Income_By_Racial_Demographic_Figure) Income By Racial Demographic Figure
```{r race-income-plot,fig.cap= "(ref:Income_By_Racial_Demographic_Figure)"}
library(tidyverse)
library(ggplot2)
...
(ref:Whiteness_By_Region_Boxplot) Whiteness By Region Boxplot
```{r Race-income-Box-plot, fig.cap="(ref:Whiteness_By_Region_Boxplot)"}
...
(ref:Demographics_By_Region_Table) Demographics By Region Table

```{r ZIP_Region_Table, fig.cap="(ref:Demographics_By_Region_Table)"}
...
I will now refer to Figure\ \@ref(fig:Income_By_Racial_Demographic_Figure), Figure\ \@ref(figWhiteness_By_Region_Boxplot), and Table\ \@ref(tabDemographics_By_Region_Table).
