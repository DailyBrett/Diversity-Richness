...
ggplot(Zipcode_Census_data) +
  geom_smooth(aes(x = X_Total_Population_White_Alone, y = Median_Household_Income, color = "red"), fill ="white", show.legend = T)  +
  geom_smooth(aes(x = X_Total_Population_Black_or_African_American_Alone, y = Median_Household_Income, color = "blue"), fill = "white", show.legend = T) +
  geom_smooth(aes(x = X_Total_Population_Asian_Alone, y = Median_Household_Income, color = "green"), fill = "white", show.legend = T) +
  geom_smooth(aes(x = X_Total_Population_American_Indian_And_Native_Alaskan_Alone, y = Median_Household_Income, color = "purple"), fill = "white", show.legend = T) +
  geom_smooth(aes(x = X_Hispanic, y = Median_Household_Income, color = "yellow"), fill = "white", show.legend = T) +
  scale_color_manual(values = c("red" = "red", "blue" = "blue", "green" = "green", "purple" = "purple", "yellow" = "yellow"),
                     name = "Race",
                     labels = c("White", "Black or African American", "Asian", "American Indian And Native Alaskan", "Hispanic")) #created a more effective key +
  labs(x = "Percentage Population of Population for Each Racial Demgraphic", y = "Median Household Income",
       title = "Racial Demographics and Median Household Income")
